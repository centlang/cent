...
private:
    ...
    [[nodiscard]] std::unique_ptr<ast::Type> parse_arraylike_type();
    ...
    [[nodiscard]] std::vector<std::unique_ptr<ast::Type>> parse_type_args();

    [[nodiscard]] std::vector<OffsetValue<std::string>> parse_type_params();
